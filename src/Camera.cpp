...
namespace Gerenciador
{
  ...
  Camera::Camera(const sf::Vector2f tamJanela) : limiteCamera(sf::IntRect(-1, -1, -1, -1)), tamJanela(tamJanela),
  ...
  void Camera::atualizar(const sf::Vector2f pos, sf::Vector2f tam)
  {
    ...
    if (pos.x + tam.x > limiteObjeto.left + limiteObjeto.width && limiteObjeto.left + limiteObjeto.width < limiteCamera.left + limiteCamera.width)
    {
    ...
    if (pos.y + tam.y > limiteObjeto.top + limiteObjeto.height && limiteObjeto.top + limiteObjeto.height < limiteCamera.top + limiteCamera.height)
    {
